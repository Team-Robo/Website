...
import { getMetadata } from "@/lib/shared/metadata";
...
const getContactPageData = () => {
  return {
    ...
    slug: "contact",
    seo: {
      metaTitle: "Contact Team Robo - Get in Touch",
      metaDescription: "Get in touch with Team Robo at NTU EEE. Visit us at our lab or reach out through our contact form for collaborations and inquiries.",
    },
    dynamic_zone: [
      {
        ...
        sub_heading: "Connect with Team Robo. Whether you're interested in collaboration, have questions about our research, or want to learn more about our projects, we'd love to hear from you.",
        CTAs: [
          {
            text: "Join Us",
      ...
      },
      {
        ...
        content: {
          ...
          address: {
            title: "Team Robo Lab",
            street: "MLDA@EEE, 50 Nanyang Ave",
      ...
      },
      {
        ...
        faqs: [
          {
            question: "What resources are available under Team Robo?",
      ...
      },
      {
        ...
        sub_heading: "Interested in joining Team Robo? Check out our recruitment opportunities and application process.",
        CTAs: [
          {
