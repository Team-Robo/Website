...
const teams = [
	{
		...
		members: [
			...
			},
			{
				...
				image: "/members/2026/jason.png",
				link: "/en",
			},
			{
				name: "Chang Wenda",
				role: "Engineer",
				image: "/members/2026/wenda.png",
				link: "/en",
			},
			{
				name: "Khiem Nguyen",
				role: "Engineer",
				image: "/members/2026/khiem.png",
				link: "/en",
			},
			{
				name: "Qu Yi Nuo",
				role: "Engineer",
				image: "/members/2026/yinuo.png",
				link: "/en",
			},
		],
	},
	...
	return (
		<Container className="py-40">
			...
			<Subheading className="max-w-3xl mx-auto mb-10">
				Meet the Team Robo members across different academic years.
			</Subheading>
