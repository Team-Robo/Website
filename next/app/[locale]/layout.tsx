...
const getHardcodedNavbarData = () => {
  return {
    ...
    logo: {
      ...
      team: "Team Robo",
      image: {
        url: "data:image/svg+xml,%3csvg width='200' height='200' xmlns='http://www.w3.org/2000/svg'%3e%3crect width='200' height='200' fill='%23000000'/%3e%3ctext x='50%25' y='50%25' text-anchor='middle' dy='.3em' fill='%23FFFFFF' font-size='32' font-family='Arial, sans-serif'%3eTeam Robo%3c/text%3e%3c/svg%3e",
        alternativeText: "Team Robo Logo",
      },
    },
  };
};
...
const getHardcodedFooterData = () => {
  return {
    ...
    copyright: "© 2025 Team Robo. All rights reserved.",
...
export async function generateMetadata({
  ...
  const defaultSeo = {
    metaTitle: "Team Robo - Building Autonomous Systems",
    metaDescription: "Robotics Team under NTU Team Robo, building autonomous systems. 2nd place ICRA BARN 2024, Finalist ICRA BARN 2025.",
  };
  
  return getMetadata(defaultSeo);
}
