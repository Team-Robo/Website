...
const hardcodedTestimonials = [
	...
	{
		id: 3,
		text: "Working with Team Robo has been incredible. Dun Yan's leadership and the team's technical expertise make them formidable competitors.",
		user: {
			firstname: "Dr. Emily",
			lastname: "Rodriguez",
	...
	{
		id: 8,
		text: "Team Robo's work on LiDAR processing and obstacle detection showcases practical engineering skills essential for real-world robotics.",
		user: {
			firstname: "Dr. Robert",
			lastname: "Chang",
